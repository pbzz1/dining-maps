...
SEED = [
    ...
    # --- 2026-09-02 확장 브랜드 조사분 ---
    # 서울신문 2026-08-10 "샐러디 8/13 메뉴 개편, 고추장제육 3종"
    ("샐러디", "고추장제육", "2026-08-13"),
    # koreadaily 2026-08-31 파파존스 신메뉴 판매 시작
    ("파파존스", "불닭까르보치킨피자", "2026-08-31"),
    # 한국경제 2026-07-09 메가커피 여름 신메뉴 6종
    ("메가커피", "복숭아퐁당요거트스무디", "2026-07-09"),
    ("메가커피", "멋쟁이토마토스무디", "2026-07-09"),
    ("메가커피", "초당옥수수프라페", "2026-07-09"),
    ("메가커피", "포도녹차젤리크러쉬", "2026-07-09"),
    ("메가커피", "치즈케이크딸기요거트크레페", "2026-07-09"),
    ("메가커피", "와앙핫치즈스틱", "2026-07-09"),
    # 배스킨라빈스 9월 이달의 맛 (공식 사이트 9/1~9/30)
    ("배스킨라빈스", "도쿄바나나크렘브륄레", "2026-09-01"),
    # 폴바셋 시즌 메뉴 -- 판매 확인 시점 기준 근사치
    ("폴바셋", "초당옥수수", "2026-07-16"),
]
