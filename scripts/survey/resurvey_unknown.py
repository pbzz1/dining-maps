...
browser tools rather than another retry.
    ...
    python scripts/survey/resurvey_unknown.py --dry-run     # look before writing
    python scripts/survey/resurvey_unknown.py               # update the CSV in place
    python scripts/survey/resurvey_unknown.py --brand KFC   # just one
